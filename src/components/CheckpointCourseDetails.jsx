...
const CheckpointCourseDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-pink-800 to-pink-600 text-white">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="space-y-6 ">
            {examDetails.examTopics.map((topic, index) => (
              <div key={index} className="bg-white rounded-lg border-l-8 border-pink-500 shadow-lg p-6 ">
      ...
      <section className="py-16 bg-gradient-to-r from-pink-900 to-pink-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 text-gray-200">
            Register now and prepare for your Checkpoint certification
          </p>
...
export default CheckpointCourseDetails;
